...
const PIECES: Record<string, React.ReactNode> = {
  ...
  wr: (
    <g style={{fill:'#fff',stroke:'#000',strokeWidth:'1.5',strokeLinecap:'round',strokeLinejoin:'round'}} transform="translate(0,0.3)">
  ...
  wb: (
    <g style={{fill:'none',stroke:'#000',strokeWidth:'1.5',strokeLinecap:'round',strokeLinejoin:'round'}} transform="translate(0,0.6)">
  ...
  wn: (
    <g style={{fill:'none',stroke:'#000',strokeWidth:'1.5',strokeLinecap:'round',strokeLinejoin:'round'}} transform="translate(0,0.3)">
      <path d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18" style={{fill:'#fff'}}/>
  ...
  bk: (
    <g style={{fill:'none',stroke:'#000',strokeWidth:'1.5',strokeLinecap:'round',strokeLinejoin:'round'}}>
      ...
      <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25" style={{fill:'#000',strokeLinecap:'butt',strokeLinejoin:'miter'}}/>
  ...
  br: (
    <g style={{fill:'#000',stroke:'#000',strokeWidth:'1.5',strokeLinecap:'round',strokeLinejoin:'round'}} transform="translate(0,0.3)">
      <path d="M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z" strokeLinecap="butt"/>
      ...
      <path d="M 12,35.5 L 33,35.5" style={{fill:'none',stroke:'#fff',strokeWidth:'1',strokeLinejoin:'miter'}}/>
  ...
  bb: (
    <g style={{fill:'none',stroke:'#000',strokeWidth:'1.5',strokeLinecap:'round',strokeLinejoin:'round'}} transform="translate(0,0.6)">
      ...
      <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18" fill="none" strokeLinejoin="miter" style={{stroke:'#fff'}}/>
    </g>
  ),
  bn: (
    <g style={{fill:'none',stroke:'#000',strokeWidth:'1.5',strokeLinecap:'round',strokeLinejoin:'round'}} transform="translate(0,0.3)">
      <path d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18" style={{fill:'#000'}}/>
      <path d="M 24,18 C 24.38,20.91 18.45,25.37 16,27 C 13,29 13.18,31.34 11,31 C 9.958,30.06 12.41,27.96 11,28 C 10,28 11.19,29.23 10,30 C 9,30 5.997,31 6,26 C 6,24 12,14 12,14 C 12,14 13.89,12.1 14,10.5 C 13.27,9.506 13.5,8.5 13.5,7.5 C 14.5,6.5 16.5,10 16.5,10 L 18.5,10 C 18.5,10 19.28,8.008 21,7 C 22,7 22,10 22,10" style={{fill:'#000'}}/>
...
export default function ChessPiece({ color, type, size }: Props) {
